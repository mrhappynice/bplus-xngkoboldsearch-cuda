...
# Let the NVIDIA runtime know what we need; 'graphics' enables Vulkan/GL
...
RUN apt-get update && apt-get install -y --no-install-recommends \
    ...
    git build-essential \
    libxslt1.1 libxslt-dev zlib1g zlib1g-dev libffi-dev libssl-dev vulkan-tools libvulkan1 \
